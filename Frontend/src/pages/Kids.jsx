    ...
    <div className="bg-gray-50 min-h-screen pb-12">
      ...
      <div className="bg-blue-600 py-12 mb-8">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-white text-center">Kids' Collection</h1>
          <p className="text-blue-100 text-center mt-2">Discover our latest children's fashion items</p>
        </div>
      </div>
