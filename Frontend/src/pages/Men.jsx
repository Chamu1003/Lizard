...
export default function Men() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-12">
      {/* Header Banner */}
      <div className="bg-blue-700 py-12 mb-8">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-white text-center">Men's Collection</h1>
          <p className="text-blue-100 text-center mt-2">Discover our latest men's fashion items</p>
        </div>
      </div>
